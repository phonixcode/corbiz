                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        ...
                        <div class="site-box">
                            ...
                            <div class="content">
                                <!-- H3 heading -->
                                <h3><a href="/services-details">Consultancy</a></h3>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        ...
                        <div class="site-box">
                            ...
                            <div class="content">
                                <!-- H3 heading -->
                                <h3><a href="/services-details">Financial planning</a></h3>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        ...
                        <div class="site-box">
                            ...
                            <div class="content">
                                <!-- H3 heading -->
                                <h3><a href="/services-details">Business research</a></h3>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        ...
                        <div class="site-box">
                            ...
                            <div class="content">
                                <!-- H3 heading -->
                                <h3><a href="javascript:void(0)">Consultancy</a></h3>
                                ...
                                <!-- Read more -->
                                <a class="site-permalink" href="javascript:void(0);">
                                    <span>MORE</span>
                                    <i class="icon-service-arrow"></i>
                                </a>
