    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                    ...
                    <div class="site-portfolio-tabs-content">
                        ...
                        <div class="all web-development portfolio-items col-sm-4 col-xs-12">
                            ...
                            <div class="site-box">
                                ...
                                <div class="portfolio-caption">
                                    ...
                                    <a class="venobox" href="{{ asset('assets/images/portfolio-1.jpg') }}"
                                        data-gall="myGallery">
                        ...
                        <div class="all web-design portfolio-items col-sm-4 col-xs-12">
                            ...
                            <div class="site-box">
                                ...
                                <div class="portfolio-caption">
                                    <!-- Light box open click on icon -->
                                    <a class="venobox" href="{{ asset('assets/images/portfolio-2.jpg') }}"
                                        data-gall="myGallery">
                                        <i class="fa fa-plus"></i> <!-- Icon -->
                                    </a>
                                    <h5>Web Development</h5> <!-- heading -->
                        ...
                        <div class="all branding portfolio-items col-sm-4 col-xs-12">
                            ...
                            <div class="site-box">
                                ...
                                <div class="portfolio-caption">
                                    <!-- Light box open click on icon -->
                                    <a class="venobox" href="{{ asset('assets/images/portfolio-3.jpg') }}"
                                        data-gall="myGallery">
                                        <i class="fa fa-plus"></i> <!-- Icon -->
                                    </a>
                        ...
                        <div class="all branding portfolio-items col-sm-4 col-xs-12">
                            ...
                            <div class="site-box">
                                ...
                                <div class="portfolio-caption">
                                    <!-- Light box open click on icon -->
                                    <a class="venobox" href="{{ asset('assets/images/portfolio-5.jpg') }}"
                                        data-gall="myGallery">
                                        <i class="fa fa-plus"></i> <!-- Icon -->
                                    </a>
                                    <h5>Branding</h5> <!-- heading -->
                        ...
                        <div class="all logo-design portfolio-items col-sm-4 col-xs-12">
                            ...
                            <div class="site-box">
                                ...
                                <div class="portfolio-caption">
                                    <!-- Light box open click on icon -->
                                    <a class="venobox" href="{{ asset('assets/images/portfolio-4.jpg') }}"
                                        data-gall="myGallery">
                                        <i class="fa fa-plus"></i> <!-- Icon -->
                                    </a>
                        ...
                        <div class="all branding portfolio-items col-sm-4 col-xs-12">
                            ...
                            <div class="site-box">
                                ...
                                <div class="portfolio-caption">
                                    <!-- Light box open click on icon -->
                                    <a class="venobox" href="{{ asset('assets/images/portfolio-6.jpg') }}"
                                        data-gall="myGallery">
                                        <i class="fa fa-plus"></i> <!-- Icon -->
                                    </a>
                                    <h5>Branding</h5> <!-- heading -->
                ...
                <!-- Button -->
                <a href="/our-work" class="theme-btn">See More</a>
